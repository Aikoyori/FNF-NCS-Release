...
class MenuCharacter extends FlxSprite
{
	private static var settings:Map<String, CharacterSetting> = [
		...
		'ncsball' => new CharacterSetting(60, 80, 1.4),
		'comingsoon' => new CharacterSetting(15, 15, 1.4)
	];
	...
	public function new(x:Int, y:Int, scale:Float, flipped:Bool)
	{
		...
		animation.addByPrefix('ncsball', "ncs balls smh", 24);
		animation.addByPrefix('comingsoon', "coming soon", 24);
