...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		#if windows
		executeModchart = FileSystem.exists(Paths.lua(StringTools.replace(PlayState.storyPlaylist[0]," ", "-").toLowerCase()  + "/modchart"));
		#end
		#if !cpp
		executeModchart = false; // FORCE disable for non cpp targets
		#end

		trace('Mod chart: ' + executeModchart + " - " + Paths.lua(StringTools.replace(PlayState.storyPlaylist[0]," ", "-").toLowerCase() + "/modchart"));
		...
		kadeEngineWatermark = new FlxText(4,healthBarBG.y + 50,0,SONG.song + " " + (storyDifficulty == 2 ? "Hard" : storyDifficulty == 1 ? "Normal" : "Easy") + (Main.watermarks ? " - FNF [NCS Release]" : ""), 16);
	...
	private function generateSong(dataPath:String):Void
	{
		...
		#if windows
			var songPath = 'assets/data/' + StringTools.replace(PlayState.storyPlaylist[0]," ", "-").toLowerCase() + '/';
